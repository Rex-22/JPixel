...
public class KeyEvent extends Event {
    ...
    public static final int KEY_ARROW_LEFT      = 0x25;
    public static final int KEY_ARROW_UP        = 0x26;
    public static final int KEY_ARROW_RIGHT     = 0x27;
    public static final int KEY_ARROW_DOWN      = 0x28;
    ...
    public static final int KEY_KEYPAD_UP          = 0xE0;
    public static final int KEY_KEYPAD_DOWN        = 0xE1;
    public static final int KEY_KEYPAD_LEFT        = 0xE2;
    public static final int KEY_KEYPAD_RIGHT       = 0xE3;
    ...
    public static final int KEY_CIRCUMFLEX               = 0x0202; // the ^ key
